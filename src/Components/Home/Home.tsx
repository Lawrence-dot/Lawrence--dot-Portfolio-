...
function Home() {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    setSending(true);
    emailjs.sendForm('service_9q6277m', 'template_i25cj5c', '#form', 'OEDYqzhwy0dl68t7y')
    .then(()=>{
      form.current?.reset();
    }).catch (()=>{
      setSending(false);
  ...
  return (
      <div className="Home dark:backdrop-grayscale" onClick={closeNav} id={allContext.theme}>
        <div className="body dark:backdrop-grayscale">
          <Fade down>
            ...
            >
              <div className="logo">
                <img className="w-100 transition" src={require('../../Assets/logo.jpg')} alt="Logo" />
              </div>
          ...
          <div className="sectionHead ">
            <div className="intro container-m my-auto text-center text-white md:py-64 " id="homeHead">
          ...
          <div
            className="abtContents mx-auto py-3 bg-light dark:bg-dark container-m"
          >
            <Fade up>
                ...
                <div className="flex flex-wrap my-5 justify-center row">
                  ...
                  <div className="w-full my-auto md:w-64">
                    <p className="text-center">
                      {" "}
                      My Name is Ojediran Lawrence. A Computer Engineering
                      Student with deep passion for design and development of
                      software products. I Design Interactive and Responsive Websites and Web Applications.
                    </p>
                  </div>
                </div>
          ...
          <div className="contactContents container-m bg-white dark:bg-black opacity-90">
            <div className="contactMe py-4text-black dark:text-white" id="contact">
              <Fade down>
                <div className="contactJHead flex justify-center">
                  <h1 className="text-4xl md:text-5xl font-bold border-left my-4"> Contact Me </h1>
                </div>
              </Fade>
                ...
                <div className="flex flex-col sm:flex-row justify-center">
                  <div className="contactInfo mx-2 justify-end sm:w-64 flex my-auto flex-col">
                    <div className="mx-auto mt-2 sm:mt-0">
                      <span className="flex w-64 p-1 rounded my-2 border border-dark dark:border-light">
                      ...
                      <ul className="flex justify-around">
                        <li className="contactLink github">
                          <a href="https://github.com/Lawrence-dot">
                            {" "}
                            <SiGithub color={allContext.theme === "light" ? "red" : "white"} />
                          </a>
                        </li>

                        <li className="contactLink email">
                          <FaEnvelope color={allContext.theme === "light" ? "red" : "white"} />
                        </li>

                        <li className="contactLink whatsapp">
                          <a href="tel:09082547402">
                            <SiWhatsapp color={allContext.theme === "light" ? "red" : "white"} />
                          </a>
                        </li>

                        <li className="contactLink linkedin">
                          <a href="https://www.linkedin.com/in/ojediran-lawrence-43b0b41b5">
                            <SiLinkedin color={allContext.theme === "light" ? "red" : "white"} />
                          </a>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="contactForm flex justify-center">
                    ...
                    >
                      ...
                      <input
                        ...
                        name="message"
                      />
                      <button className="border p-1 rounded border-dark dark:border-light hover:text-white hover:bg-dark dark:hover:bg-light light:hover:bg-darks pointer"
                        type="submit"
                      >
                        {sending ? <CircularProgress size={"20px"}  color="success" /> : "Send" }
                      </button>
                    </form>
                  </div>
                </div>
